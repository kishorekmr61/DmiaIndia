package com.dmia.bioAttendance.ui.AdminDashboardActivity
...
import com.dmia.bioAttendance.ui.adminDashBoard.AdminDashBoardViewModel
...
class AdminDashboardActivity : AppCompatActivity() {
    ...
    open fun activateUser() {
        ...
        var employeedetails = Gson().fromJson(AppPreference.read(ApiConstant.EMPLOYEEDETAILS, ""),UsersData::class.java)
